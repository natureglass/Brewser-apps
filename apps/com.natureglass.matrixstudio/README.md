...
**Matrix Studio** is a design-and-control studio for addressable-LED matrix panels. Draw straight onto a glowing on-screen grid, stir it like fluid, or run built-in animations - then stream the picture live to a real ESP32-driven panel over USB serial.
 ...
 **Connecting to hardware.** There are two paths, and the app is fully functional offline - a link only mirrors the canvas to the panel. *Web Serial over USB* comfortably runs 30–60 fps at high baud. Brightness is applied on-device for power limiting - 512 LEDs at full white pull about 30 A. A matching ESP32 sketch is bundled in the app’s assets so you can flash your own controller.
...
- **Live app:** [Matrix Studio](https://brewser.io/matrix-studio/)
