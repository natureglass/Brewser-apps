 ...
 *
 * Protocol v2 (little-endian byte stream):
...
#define LED_PIN_DEFAULT       21       // shared-safe on C6 + classic ESP32 (app CONFIG overrides it)
#define LED_COUNT_DEFAULT     512
#define BRIGHTNESS_DEFAULT    20      // Adafruit scale: out = (c * (b+1)) >> 8
...
#define ACK_AFTER_SHOW        1       // "OK <seq>" after every accepted packet (diagnostic)
